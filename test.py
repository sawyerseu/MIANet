...
parser.add_argument('--save-dir', default='/home/sawyer/jupyter/CrowdCountingRGBT/SCANet_v7/RGBTCC_pth/0309-213846',                  # 1014-160206 for IADM;  1014-121731 for SCANet
                        help='model directory')
parser.add_argument('--model', default='best_model_6.pth'
                    , help='model name')

parser.add_argument('--device', default='0,1', help='gpu device')
...
if __name__ == '__main__':
    ...
    visual_dir = '/home/sawyer/jupyter/CrowdCountingRGBT/SCANet_v7_2/SCANet_v7_2_RGBTCC'
