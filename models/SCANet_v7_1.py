...
class SCANet(nn.Module):
    def __init__(self, load_weights = False):
        ...
        self.reg = nn.Sequential(nn.Conv2d(128, 1, 1),
                                 nn.ConvTranspose2d(1, 1, 1, 2, 0, 1)
                                 )
    ...
    def forward(self, x):
        ...
        # middle part - SCA
        o0_first, o0_first, _= self.sca0(x1, x2)
        o1_first, o2_first, conc1 = self.sca1(o0_first, o0_first)                #torch.Size([1, 512, 60, 90])
